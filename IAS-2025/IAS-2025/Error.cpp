...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = // таблица ошибок
	{
		...
		ERROR_ENTRY(121, "Тип идентификатора не определен"),
		...
		ERROR_ENTRY(133, "Отсутствует точка main"),
		ERROR_ENTRY(134, "Обнаружено несколько точек main"),
		...
		ERROR_ENTRY(603, "Ошибочные параметры при определении функции"),
		ERROR_ENTRY(604, "Ошибочные параметры при вызове функции"),
		...
		ERROR_ENTRY(608, "Ошибка при определении условия смены"),
		...
		ERROR_ENTRY(704, "Несовпадение типов передаваемыемыми параметров"),
		ERROR_ENTRY(705, "Количество ожидаемого функцией и переданного параметров не совпадает"),
